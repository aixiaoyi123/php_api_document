...
class JavaNativeHttpElement extends JavaHttpElement{
	...
	/**字符串*/
	Element::TYPE_KEY_STRING                => '../document_sdk/javanativepan/http/string.java',
	/**4位整型*/
	Element::TYPE_KEY_INT        	        => "../document_sdk/javanativepan/http/int.java",
	/**长整形*/
	Element::TYPE_KEY_LONG                  => "../document_sdk/javanativepan/http/long.java",
	/**浮点数*/
	Element::TYPE_KEY_FLOAT                 => "../document_sdk/javanativepan/http/float.java",
	/**布尔型*/
	Element::TYPE_KEY_BOOLEAN               => "../document_sdk/javanativepan/http/boolean.java",
	/**文件参数*/
	DataHttpElement::HTTP_KEY_FILE          => "../document_sdk/javanativepan/http/file.java",
	/**文件路径设置*/
	DataHttpElement::HTTP_KEY_FILE_PATH     => "../document_sdk/javanativepan/http/filepath.java",
	/**结果解析*/
	DataHttpElement::HTTP_KEY_OBJECT        => "../document_sdk/javanativepan/http/object.java",
	/**结果数组解析*/
	DataHttpElement::HTTP_KEY_OBJECT_LIST   => "../document_sdk/javanativepan/http/object_list.java",
	/**对象*/
	DataHttpElement::HTTP_KEY_RESULT        => "../document_sdk/javanativepan/http/result.java",
	/**对象数组*/
	DataHttpElement::HTTP_KEY_RESULT_LIST   => "../document_sdk/javanativepan/http/result_list.java",
	/**整体*/
	DataHttpElement::HTTP_KEY_HTTP          => "../document_sdk/javanativepan/http/http.java",
	/**头部引用*/
